...
<div class="flex justify-center">
  <h1 class="mt-4 font-lao text-4xl font-extrabold">ຂໍ້ມູນປະຊາກອນທົ່ວປະເທດທັງໝົດ</h1>
</div>



<div class=" bg-gradient-to-b from-gray-300 to-white  mt-8 px-4 ">
  <h2 class="font-bold font-lao bg-slate-300 px-3 py-1 rounded-full inline-block">
  ຂໍ້ມູນສະຖິຕິທັງໝົດ
</h2>
